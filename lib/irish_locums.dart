...
class IrishLocum extends StatefulWidget {
  const IrishLocum({Key? key}) : super(key: key);

  @override
  State<IrishLocum> createState() => _IrishLocumState();
}

class _IrishLocumState extends State<IrishLocum> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(
          child: Text('IRISH LOCUMS',style: TextStyle(color: Colors.black),),
        ),
      ),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          height: 150,
                          child: Image(
                            image: AssetImage('assets/irishlocum.png'),
                          ),
                        ),
                        SizedBox(width: 20,),
                        Container(
                          height: 150,
                          child: Image(
                            image: AssetImage('assets/irishlocum2.png'),
                          ),
                        ),
                        SizedBox(width: 20,),
                        Container(
                          height: 150,
                          child: Image(
                            image: AssetImage('assets/irishlocum3.png'),
                          ),
                        )
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          height: 150,
                          child: Image(
                            image: AssetImage('assets/irishlocum4.png'),
                          ),
                        ),
                        SizedBox(width: 20,),
                        Container(
                          height: 150,
                          child: Image(
                            image: AssetImage('assets/irishlocum5.png'),
                          ),
                        ),
                        SizedBox(width: 20,),
                        Container(
                          height: 150,
                          child: Image(
                            image: AssetImage('assets/irishlocum6.png'),
                          ),
                        )
                      ],
                    ),
